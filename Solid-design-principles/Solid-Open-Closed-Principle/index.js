...
let product = [apple, tree, house];
let pf = new ProductFilter();
console.log(`Green products(old):`);
for (let p of pf.filterByColor(product, Color.green))
...
for (let p of bf.filter(product, new ColorSpecification(Color.green))) {
  console.log(`* ${p.name} is green`);
}
...
for (let p of bf.filter(product, spec)) {
